...
- **ClaudeSessionRow** — green dot on the left when the session is active, folder name in the middle, "⌘N" hint on the right for the first nine rows. Right-click → Remove.
